...
class UsersController extends SlController {
	...
	private function createAco() {
		$aco = new Aco();
		$aco -> create();
		$aco -> save(array('parent_id' => null, 'alias' => 'controllers'));
		//1
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Users'));
		//2
		$aco -> create();
		$aco -> save(array('parent_id' => 2, 'alias' => 'Groups'));
		//3
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Notices'));
		//4
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'GuestBooks'));
		//5
		$aco -> create();
		$aco -> save(array('parent_id' => 5, 'alias' => 'GuestBookComments'));
		//6
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Questions'));
		//7
		$aco -> create();
		$aco -> save(array('parent_id' => 7, 'alias' => 'QuestionComments'));
		//8
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Faqs'));
		//9
		$aco -> create();
		$aco -> save(array('parent_id' => 9, 'alias' => 'FaqCategories'));
		// 10
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Blogs'));
		//11
		$aco -> create();
		$aco -> save(array('parent_id' => 11, 'alias' => 'BlogCategories'));
		//12
		$aco -> create();
		$aco -> save(array('parent_id' => 11, 'alias' => 'BlogComments'));
		//13
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'CkeditorAssets'));
		//14
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Galleries'));
		// 15
		$aco -> create();
		$aco -> save(array('parent_id' => 15, 'alias' => 'GalleryCategories'));
		// 16
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Contacts'));
		// 17
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Portfolios'));
		// 18
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Histories'));
		// 19
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Home'));
		//20
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Intro'));
		//21
		$aco -> create();
		$aco -> save(array('parent_id' => 1, 'alias' => 'Resources'));
		//22
	}
